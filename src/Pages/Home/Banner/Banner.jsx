...
<div className="carousel w-full h-[600px]">
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className="absolute h-full justify-left flex items-center  left-0 bottom-0 gap-4 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
        <div className='text-white font-semibold space-y-4 w-2/5 pl-12 pt-4'>
            ...
            <div>
                <button className='btn bg-[#FF3811] btn-secondary'>Discover More</button>
    ...
    <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0 gap-4">
      <a href="#slide4" className="btn btn-circle text-red">❮</a> 
  ...
  <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0 gap-4">
      <a href="#slide2" className="btn btn-circle text-red">❮</a> 
